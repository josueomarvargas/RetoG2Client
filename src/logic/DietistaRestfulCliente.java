 ...
 * USAGE:
 * <pre>
 *        DietistaRestfulCliente client = new DietistaRestfulCliente();
...
public class DietistaRestfulCliente {
    ...
    public <T> T getDietistaTodos_XML(Class<T> responseType) throws ClientErrorException {
        WebTarget resource = webTarget;
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_XML).get(responseType);
    }
